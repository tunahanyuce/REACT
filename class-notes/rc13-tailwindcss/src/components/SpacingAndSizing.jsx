  ...
  return (
    <div>
      ...
      <div>
        ...
        <button className="bg-green-500 text-white mx-4 px-4 py-4 border border-orange-500 rounded-full">Tıkla</button>
        <button className="bg-green-500 text-white mx-4 px-4 py-2 border border-red-500 rounded-[50%]">Tıkla</button>
      </div>
    </div>
  );
};
